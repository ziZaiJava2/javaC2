...
public class LineInStation {
	...
	public static List<Person> comingPassagers() {
		...
		for (int i = 0; i < random.nextInt(3); i++) {
			...
			Person passagers = new Person(names.get(random.nextInt(names.size())));

			passager.add(passagers);
		}
	...
	private static void saleTiket(List<Person> line) {
...
class Person {
	...
	public void add(Person passagers) {
