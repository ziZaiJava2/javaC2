...
public class ListMapPractice {
	 ...
	 */
	public static List<Student> getStudentListMajoredInSoftwareEngineering(ArrayList<Student> allStudents){
		List<Student>  majoreList1= new ArrayList<Student>();
		for(Student student : allStudents){
			if("Software Engineering".equals(student.getMajor())){
				majoreList1.add(student);	
			}
		}
		return majoreList1;		
	}
	 ...
	 */
	public static List<Student> getStudentListMajoredInComputerScience(ArrayList<Student> allStudents){
		List<Student>  majoreList2= new ArrayList<Student>();   
		for(Student student : allStudents){
			if("Computer Science".equals(student.getMajor())){
				majoreList2.add(student);	
			}
		}
		return majoreList2;
	}
	 ...
	 */
	public static Map<String, Student> constructStudentMapWithNameKey(ArrayList<Student> allStudents){
		for(Student student : allStudents){
			studentMapWithNameKey.put(student.getName(),student);
		}
	 ...
	 */
	public static Map<Integer, Student> constructStudentMapWithIdKey(ArrayList<Student> allStudents){
		for(Student student : allStudents){
			studentMapWithIdKey.put(student.getId(),student);
		}		
