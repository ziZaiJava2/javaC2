...
public class Station {
	...
	public static void main(String[] args) {
		...
		TicketSellTask tk1 = new TicketSellTask(ticketSellSystem, getPassager());
		TicketSellTask tk2 = new TicketSellTask(ticketSellSystem, getPassager());
		TicketSellTask tk3 = new TicketSellTask(ticketSellSystem, getPassager());
		TicketSellTask tk4 = new TicketSellTask(ticketSellSystem, getPassager());
