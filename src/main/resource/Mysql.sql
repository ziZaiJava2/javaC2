...
insert into orders(物品名称,订购日期,到货日期,发货日期,订单总价,订单状态) values('外星人电脑','2013-06-25','2015-03-12','2013-08-22',18999,'未付款');
insert into ordergoods(物品号,订单号,数量) values(2,1,1);

insert into orders(物品名称,订购日期,到货日期,发货日期,订单总价,订单状态) values('小米Mix','2013-06-25','2015-03-12','2013-08-22',3199,'未付款');
insert into ordergoods(物品号,订单号,数量) values(4,2,1);

insert into orders(物品名称,订购日期,到货日期,发货日期,订单总价,订单状态) values('小米无人机','2013-06-25','2015-03-12','2013-08-22',1999,'未付款');
insert into ordergoods(物品号,订单号,数量) values(9,3,1);

select 物.物品名, org.数量, 物.原价, 物.现价, 物.现价/物.原价  from  物品 物, ordergoods org, orders ors  where 物.物品名 = ors.物品名称;
